...
def get_client_map(settings: Settings) -> dict[str, BaseDeliberationClient]:
    """Return enabled provider clients keyed by model id."""
    return {c.model_key: c for c in get_enabled_clients(settings)}
